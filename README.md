...
✔️ **Consumo de API externa** (Específicamente Exchange Rate API)
...
✔️ **Se perimite al usuario elegir entre las diferentes monedas a convertir**
...
Mira el resultado calculado según tu elección
...
✔️ Agregar interfaz gráfica (Swing / JavaFX)

✔️ Añadir más monedas disponibles

✔️ Guardar historial de conversiones

✔️ Implementar manejo de excepciones más detallado
